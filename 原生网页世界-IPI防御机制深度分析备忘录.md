...
蓝图版原生网页世界(`agent-runtime-extension-v1.1-blueprint`)在构建元素注册表时,**不做全量 DOM 序列化**,而是在注入内核层对每个 DOM 节点做实时可见性过滤:
...
### 实测一:CSS 攻防矩阵(2026-08-31,file:// 本地夹具 `test_fixtures/ipi_matrix.html`)
