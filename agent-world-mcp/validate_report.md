...
**汇总**: TP=8 TN=2 FP=0 FN=0 AM=0 AMs=0 SKIP=1
...
- truth: 无变化
- 证据窗: polls=3 total=613ms first_change=206ms stop=stable
...
- 证据窗: polls=1 total=203ms first_change=202ms stop=early-effect
...
- 证据窗: polls=1 total=418ms first_change=418ms stop=early-effect
