...
- truth: 无变化
- 证据窗: polls=3 total=613ms first_change=207ms stop=stable
...
- 证据窗: polls=1 total=362ms first_change=362ms stop=early-effect
...
- action: fill method=locator-fill
- 证据窗: polls=1 total=335ms first_change=335ms stop=early-effect
- note: 亚马逊重型电商填搜索框 → 值进入(重渲染下 digest 表现)

### bbc-headline(点头条链接→URL) [TN]
- why: 目标区域无变化(点击可能未生效,或效果发生在远处)
- truth: url: "https://www.bbc.com/" → "https://www.bbc.com/"
- 证据窗: polls=3 total=613ms first_change=204ms stop=stable
