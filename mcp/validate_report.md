...
**汇总**: TP=4 TN=1 FP=0 FN=0 AM=0 AMs=0 SKIP=0
...
- truth: 无变化
- 证据窗: polls=3 total=615ms first_change=209ms stop=stable
...
- 证据窗: polls=1 total=224ms first_change=224ms stop=early-effect
