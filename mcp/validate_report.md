...
- truth: 无变化
- 证据窗: polls=3 total=617ms first_change=207ms stop=stable
...
- 证据窗: polls=1 total=216ms first_change=216ms stop=early-effect
...
- why: 目标区域无变化(点击可能未生效,或效果发生在远处)
- truth: 无变化
- 证据窗: polls=3 total=616ms first_change=205ms stop=stable
