...
- truth: dialog可见
- 证据窗: polls=1 total=250ms first_change=250ms stop=early-effect
...
- truth: 无变化
- 证据窗: polls=3 total=655ms first_change=248ms stop=stable
...
- truth: 动画目标已变 active
- 证据窗: polls=3 total=633ms first_change=211ms stop=stable
- note: DOM 无增删、纯背景色翻转 → 应触发视觉 diff 兜底 visual-effected,TP

### visual-negative(视觉兜底负例·不误报) [TN]
- why: 目标区域无变化(点击可能未生效,或效果发生在远处)
- truth: 无变化
- 证据窗: polls=3 total=633ms first_change=205ms stop=stable
