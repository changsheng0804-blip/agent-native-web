---
name: agent-world
description: Comprehensive Web Navigation, Scraping, Form Filling, and Multi-step Interaction Skill powered by Agent-World MCP Digital Twin (CAD Blueprint + Video Changelog + Status Dashboard).
---
...
2. **多字段表单录入**：优先使用 `world_batch_fill` 一次性提交多个字段，减少通信往返。
